						...
						<div class="col-md-12">
							<div class="home-content sections">
								...
								<div class="text-center">
									<a target="_blank" href="#"><button class="btn-book btn-black">Book A Table</button></a>
									<a target="_blank" href="#"><button class="btn-menu btn-white">See The Menu</button></a>
								</div>
							</div>
						</div>
					</div>
			...
			<section id="about" class="sections lightbg">
				<div class=" text-center">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<p class="about-text">
							If you’ve been to one of our restaurants, you’ve seen – and tasted - what keeps our customer coming back for more.Perfect materials and freshly baked food,delicious Lambda cakes, muffins,and gourmet coffes make us hard to resist!<br/>Stop in today and check us out!
						</p>
					...
					<div class="col-md-5 col-md-offset-6">
						<div class="content-right">
							...
							<div class="ingre-item">
								<div class="ingredients_images"><img src="assets/images/my_images/section3-item1.png" alt="" class="img-circle"></div>
								<div class="ingredients_images"><img src="assets/images/my_images/section3-item2.png" alt="" class="img-circle"></div>
								<div class="ingredients_images"><img src="assets/images/my_images/section3-item3.png" alt="" class="img-circle"></div>
							</div>
				...
				<section id="menu" class="sections">
					...
					<section id="reviews" class="sections">
						<div class="col-md-6 col-md-offset-3">
							<div class="content-center">
								...
								<p>If you’ve been to one of our restaurants, you’ve seen – and tasted - what keeps our customer coming back for more.Perfect materials and freshly baked food,delicious Lambda cakes, muffins,and gourmet coffes make us hard to resist!<br/> Stop in today and check us out!<br/><br/>
								<small>-food inc,New York</small></p>
							</div>
						</div>
					</section>
					<!-- Sections -->
					<section id="reservation" class="sections lightbg">
						<div class=" text-center">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="col-md-6">
									<img height="424px" src="assets/images/my_images/item1-section5.png">
								</div>
								<div class="col-md-6">
									<img height="424px" src="assets/images/my_images/item2-section5.png">
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<div class="divider2"><img src="assets/images/my_images/devider2.png"></div>
								<p class="about-text">
									If you’ve been to one of our restaurants, you’ve seen – and tasted - what keeps our customer coming back for more.Perfect materials and freshly baked food.<br/>
								...
								<div class="row">
									<div class="col-md-4 col-sm-4 col-xs-12 footer-about">
										<div class="copyright text-left text-center footer-about-title ">
											...
											<p>
												Lambda's new and expanded Chelsea location represents a truly authentic Greek patisserie,featuring breakfasts of fresh croissants and streaming bowls of cafe.Lamda the best restaurant in town
											</p>
										</div>
									</div>
					...
					<script type="text/javascript" src="assets/js/fm.datetator-de.jquery.js" ></script>
					<script type="text/javascript" src="assets/js/fm.datetator.jquery.js" ></script>
					<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
					<script type="text/javascript">
						$('.res-date').datetator();
						$('#datetator_').attr("placeholder", "date *");
